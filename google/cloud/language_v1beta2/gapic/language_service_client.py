...
class LanguageServiceClient(object):
    ...
    def analyze_sentiment(
        ...
        if 'analyze_sentiment' not in self._inner_api_calls:
            self._inner_api_calls['analyze_sentiment'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['analyze_sentiment'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def analyze_entities(
        ...
        if 'analyze_entities' not in self._inner_api_calls:
            self._inner_api_calls['analyze_entities'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['analyze_entities'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def analyze_entity_sentiment(
        ...
        if 'analyze_entity_sentiment' not in self._inner_api_calls:
            self._inner_api_calls['analyze_entity_sentiment'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['analyze_entity_sentiment'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def analyze_syntax(
        ...
        if 'analyze_syntax' not in self._inner_api_calls:
            self._inner_api_calls['analyze_syntax'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['analyze_syntax'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def classify_text(
        ...
        if 'classify_text' not in self._inner_api_calls:
            self._inner_api_calls['classify_text'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        request = language_service_pb2.ClassifyTextRequest(
            document=document,
        )
        return self._inner_api_calls['classify_text'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def annotate_text(
        ...
        if 'annotate_text' not in self._inner_api_calls:
            self._inner_api_calls['annotate_text'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['annotate_text'](request, retry=retry, timeout=timeout, metadata=metadata)
